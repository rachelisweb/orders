-- One-off, service-role-only importer for audited future-season orders.
-- Future orders deliberately bypass current-stock reservations and may include
-- a product that is currently inactive while next-season data is prepared.
